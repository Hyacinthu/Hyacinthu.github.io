...
$f(x_ 0 + h,y_ 0 + k) = f(x_ 0,y_ 0) + (h\frac{\partial}{\partial x} + k\frac{\partial}{\partial y})f(x_ 0,y_ 0) +$  
...
$\frac{1}{(n+1)!}(h\frac{\partial}{\partial x} + k\frac{\partial}{\partial y})^ (n+1) f(x_ 0 + \theta h,y_ 0 + \theta k) (0<\theta<1)$
