...
（1）w<sup>\*</sup>，b<sup>\*</sup> = arg min(w，b) *L*  
...
*<center>y = b + $\sum \limits_{i=1}^7$w<sub>j</sub>x<sub>j</sub></center>*

&emsp;&emsp;类似的，可以将前二十八天的播放量作为输入：
*<center>y = b + $\sum \limits_{i=1}^{28}$w<sub>j</sub>x<sub>j</sub></center>*

&emsp;&emsp;同理，前五十六天：
*<center>y = b + $\sum \limits_{i=1}^{56}$w<sub>j</sub>x<sub>j</sub></center>*
...
![Linear models](/assets/blog_res/2022-05-02-Monday.assets/Linear%20models.png)
...
*<center>y = b + $\sum \limits_{i}$ c<sub>i</sub> Sigmoid(b<sub>i</sub> + w<sub>i</sub>x<sub>1</sub>)</center>*
...
*<center>y = b + $\sum \limits_{i}$ c<sub>i</sub> Sigmoid(b<sub>i</sub> + $\sum \limits_j$w<sub>ij</sub>x<sub>j</sub>)</center>*
...
*<center>y = b +$\sum\limits_{2i}$c<sub>i</sub>$\max$(0, b<sub>i</sub> + $\sum\limits_j$w<sub>ij</sub>x<sub>j</sub>)</center>*  
